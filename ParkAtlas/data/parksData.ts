export interface NationalPark {
  ...
  radiusKm: number;
  npsCode: string;
  /** Searchable city names, regions, or common aliases (e.g. 'moab' for Arches/Canyonlands). */
  keywords?: string[];
  /** Distinguishes national parks from state parks in combined search results. */
  type?: 'national' | 'state';
}

/** Alias for state parks — same shape, type field will be 'state'. */
export type StatePark = NationalPark;

export type ParkTerrainKey = 'coastline' | 'alpine' | 'woodland' | 'desert';
...
export const PARKS: NationalPark[] = [
  ...
  { id: '3',  name: 'Arches',               state: 'UT', lat: 38.68,  lng: -109.57, radiusKm: 40,  npsCode: 'arch', keywords: ['moab', 'red rock'] },
  { id: '4',  name: 'Badlands',             state: 'SD', lat: 43.85,  lng: -102.34, radiusKm: 60,  npsCode: 'badl', keywords: ['wall', 'south dakota'] },
  { id: '5',  name: 'Big Bend',             state: 'TX', lat: 29.25,  lng: -103.25, radiusKm: 80,  npsCode: 'bibe', keywords: ['marathon', 'terlingua', 'west texas'] },
  ...
  { id: '8',  name: 'Bryce Canyon',         state: 'UT', lat: 37.57,  lng: -112.18, radiusKm: 35,  npsCode: 'brca', keywords: ['rubys inn', 'panguitch'] },
  { id: '9',  name: 'Canyonlands',          state: 'UT', lat: 38.20,  lng: -109.93, radiusKm: 65,  npsCode: 'cany', keywords: ['moab', 'needles', 'island in the sky', 'maze'] },
  { id: '10', name: 'Capitol Reef',         state: 'UT', lat: 38.09,  lng: -111.15, radiusKm: 55,  npsCode: 'care', keywords: ['torrey', 'fruita'] },
  ...
  { id: '16', name: 'Death Valley',         state: 'CA', lat: 36.24,  lng: -116.82, radiusKm: 110, npsCode: 'deva', keywords: ['furnace creek', 'badwater', 'mojave'] },
  { id: '17', name: 'Denali',               state: 'AK', lat: 63.33,  lng: -150.50, radiusKm: 150, npsCode: 'dena', keywords: ['mount mckinley', 'mckinley', 'talkeetna'] },
  ...
  { id: '24', name: 'Grand Canyon',         state: 'AZ', lat: 36.06,  lng: -112.14, radiusKm: 80,  npsCode: 'grca', keywords: ['tusayan', 'south rim', 'north rim', 'flagstaff', 'williams'] },
  { id: '25', name: 'Grand Teton',          state: 'WY', lat: 43.79,  lng: -110.68, radiusKm: 55,  npsCode: 'grte', keywords: ['jackson', 'jackson hole', 'jenny lake'] },
  ...
  { id: '28', name: 'Great Smoky Mountains',state: 'TN', lat: 35.61,  lng: -83.53,  radiusKm: 65,  npsCode: 'grsm', keywords: ['gatlinburg', 'pigeon forge', 'cherokee', 'smoky', 'appalachian'] },
  ...
  { id: '35', name: 'Joshua Tree',          state: 'CA', lat: 33.88,  lng: -115.90, radiusKm: 70,  npsCode: 'jotr', keywords: ['palm springs', 'twentynine palms', '29 palms', 'high desert'] },
  ...
  { id: '47', name: 'Olympic',              state: 'WA', lat: 47.97,  lng: -123.50, radiusKm: 90,  npsCode: 'olym', keywords: ['port angeles', 'forks', 'hoh rainforest', 'hurricane ridge'] },
  ...
  { id: '61', name: 'Yellowstone',          state: 'WY', lat: 44.42,  lng: -110.59, radiusKm: 80,  npsCode: 'yell', keywords: ['old faithful', 'geyser', 'jackson', 'west yellowstone'] },
  { id: '62', name: 'Yosemite',             state: 'CA', lat: 37.87,  lng: -119.55, radiusKm: 70,  npsCode: 'yose', keywords: ['el capitan', 'half dome', 'mariposa', 'merced', 'yosemite valley'] },
  { id: '63', name: 'Zion',                 state: 'UT', lat: 37.30,  lng: -113.00, radiusKm: 45,  npsCode: 'zion', keywords: ['springdale', 'st george', 'angels landing', 'narrows'] },
];

export const PARK_TERRAIN_BY_ID: Record<string, ParkTerrainKey> = {
  '1': 'coastline',
  '2': 'coastline',
  '3': 'desert',
  '4': 'desert',
