...
# Fix the escaped newlines in the JSX strings - they should be literal \n in the source
content = content.replace("{'Seasonal\\\\nHighlights'}", "{'Seasonal\\nHighlights'}")
content = content.replace('{"AUTUMN\\\\n\'24"}', '{"AUTUMN\\n\'24"}')

with open('/Users/karen.mogridge/VSCodeProjects/NationalParkTracker/ParkAtlas/app/(tabs)/explore.tsx', 'w') as f:
    f.write(content)
